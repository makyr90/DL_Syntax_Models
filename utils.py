...
class ConllEntry:
    def __init__(self, id, form, lemma, pos=None, xpos=None, feats=None, parent_id=None, relation=None, deps=None, misc=None):
        self.id = id
        self.form = form
    ...
    def __str__(self):
        values = [str(self.id), self.form, self.lemma, self.pred_pos, self.pred_xpos, self.feats, str(self.parent_id), self.relation, self.deps, self.misc]
